 ...
 * 
 * �@�\
 * 1. MetaMorph���琶�������ʐ^���A(ORF)-A1.jpg�̌`����rename
 * 2. 3���̎ʐ^�����ꂼ��F����ς��č����������̂̉��Ƀ`�F�b�N�{�b�N�X�����āA
 * 	  ���̎ʐ^���������ǂ�������͂��Ă��炤�B
 * 	  (�ʐ^�̍����ɂ�ImageMagick(�O���v���O����)���g��)
 * 3. WebDAV�v���g�R����p���āAyeast�Ɏʐ^��upload����B
 * 	  (Slide http://jakarta.apache.org/ �Ɋ܂܂�Ă���WebDav cliant library���g���Ď���)
 */
...
public class SCMDConverter extends JFrame implements ActionListener
{
	...
	//--------------------------------------------------------------------------------
	// ORF_QUERY: ORF����肷��CGI�y�[�W
	//
	// http://yeast.gi.k.u-tokyo.ac.jp/tools/get_orf.cgi?name=his3 �ɃA�N�Z�X����ƁA
	// plain text�ŁA
	//
	// yor203w	his3
	//
	...
	// Windows��Linux�Ńp�X�̋�؂蕶�����Ⴄ�̂ŁAFile.separator���g��
	...
	JTextField orfField; // ORF�̃e�L�X�g�{�b�N�X
	JTextField geneNameField; // Standard Name�̃e�L�X�g�{�b�N�X
	JLabel orfMessage;
	...
	boolean isReadyORF = false; // ORF���킩���Ă��邩�ǂ���
	...
	public SCMDConverter(char[] pswd)
	{
		...
		{
			menu[i] = (JMenu) menuBar.add(new JMenu(menuList[i]));
		}
		// help menu
		menuBar.add(Box.createHorizontalGlue());
		help_menu = (JMenu) menuBar.add(new JMenu("Help"));
		...
		plateButton.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent e)
			{
				...
				JLabel platelabel1 = new JLabel("���̃v���[�g��̈ʒu����͂��Ă������� ");
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		else if (command.equals(HELP))
		{
			...
			helpMessage.setText(
				"SCMD toolkit�̎g����"
					+ newline
					+ newline
					+ "1. �摜�t�@�C���̓����Ă���t�H���_��Rename��̃t�@�C��������o�b�N�A�b�v�t�H���_��I��"
					+ newline
					+ "2. �摜�t�@�C���̓����Ă���t�H���_��������Standard name��������ORF�ł͂Ȃ��ꍇ�AStandard name(or ORF)�̍��ڂɓ���"
					+ newline
					+ "3. �t���ւ��閼�O�̌������@��I���i�l�b�g(yeast�T�[�o)���猟�� or ���[�J���t�@�C��(orf_descriptions.tab)���猟���@or �蓮�œ���)"
					+ newline
					+ "4. ���O���m�肵����First number of new name�ɕt���ւ���t�@�C�����̔ԍ������Ԃ���ɂ��邩����͂���rename files��I��"
					+ newline
					+ "5. �g�p���Ȃ��摜�̃`�F�b�N�{�b�N�X���O���Ă���Rename��I��"
					+ newline
					+ "6. rename log���m�F���āA��肪�Ȃ����Rename Execute��I��"
					+ newline
					+ "7. �t�@�C�������ϊ�����ăo�b�N�A�b�v�t�H���_�ɓ�����A���̃t�H���_���폜�����"
					+ newline
					+ "8. �g�p���Ȃ��Ƃ��ꂽ�摜��unusable�Ƃ������O�̃t�H���_�̒��ɓ������"
					+ newline
					+ "9. �����K�v�Ȃ�΁A�����select photo�ł��ꂼ��̉摜���g�p���邩�ǂ������摜�����đI��"
					+ newline
					+ "10. submit��I��"
					+ newline
					+ "11. yeast�T�[�o�[�ɉ摜�t�@�C���ƃ��O�t�@�C����������(unusable�Ƃ��̒��g��)"
					+ newline
					+ newline
					+ "���Fsubmit�ő�����t�@�C���͑O���rename�Ŗ��O���t���ւ���ꂽ�t�@�C��"
					+ newline
					+ newline
					+ "���łɑ��݂���t�H���_�ɉ摜�𑗂�Ƃ��A���肽���摜�Ɠ����̉摜�������ɂ��łɑ��݂����ꍇ�́A���̑����̉摜���ȑO���̃v���O�����ɂ���āi�G���[�Ȃ��Ɂj����ɑ���ꂽ���̂Ȃ�Ώ㏑�������A�����łȂ���Ώ㏑������"
					+ newline
					+ newline
					+ "submit���Ƀl�b�g���[�N�̃G���[�ɂ���đ��M�����f���ꂽ�Ƃ��͂�����xsubmit����"
					+ newline
					+ newline
					+ "submit�I�����ɂ͉摜�t�@�C���������Ă��邱���瑤�̃f�B���N�g���ɂ��T�[�o�[���ɂ���log�̃R�s�[���ł���B�i���O��rename_log�j���̓��e�̓e�L�X�g�G�f�B�^�Ŋm�F�ł���B�`���́u���̃t�@�C�����v�u�t���ւ����t�@�C�����v�u�T�[�o�[�ɃA�b�v���ꂽ���ԁv�ŁA���܂ŃT�[�o�[���̂��̃t�H���_�ɑ���ꂽ���ׂẴt�@�C���̋L�^�������Ă���");
		...
		else if (command.equals(RENAME))
		{
			...
			else
			{
				...
				// PhotoNumComparetor�Œ�`����鏇����sort���ꂽ 
				// PhotoNum�N���X�̏W�� -> PhotoGroup �Ƃ���Map
				...
				for (int i = 0; i < ls.length; i++)
				{
					...
					{
						imgfilenum++;
						// �t�@�C����MetaMorph�̃p�^�[���Ƀ}�b�`���Ă���ꍇ
						for (int j = 1; j <= m.groupCount(); j++)
						{
							PhotoNum pn;	
							// FP_FIRST_PHOTO_NUM�̕����ƁAFP_SECOND_PHOTO_NUM�̍�����
				...
				checkokButton.addActionListener(new ActionListener()
				{
					public void actionPerformed(ActionEvent e1)
					{
						...
						String renameText = "";		// file�����ǂ̂悤�ɕύX���邩��\�����邽�߂�HTML
						...
						okButton.addActionListener(new ActionListener()
						{
							public void actionPerformed(ActionEvent e)
							{
								...
								try
								{
									...
									if(bufolder.exists())
									{
										int ans = JOptionPane.showConfirmDialog(null, "���łɓ���ORF���̂����o�b�N�A�b�v�t�H���_�����݂��܂����A���̃t�H���_��ɏ������݂܂����H", "��ORF���̃t�H���_�����݂��܂�", JOptionPane.YES_NO_OPTION);
									...
									{
										int ans = JOptionPane.showConfirmDialog(null, "�T�[�o�[��̓�ORF���̃t�H���_�̒��̃t�@�C���Ɣԍ����d�Ȃ���������܂��B�i�T�[�o�[�̃t�H���_���̍ő�ԍ��@" + max + "�j�@��낵���ł����H", "", JOptionPane.YES_NO_OPTION);
										if(ans == JOptionPane.NO_OPTION)
										{
											flag = false;
										}
									...
									{
										confirmFrame.dispose();
										JOptionPane.showMessageDialog(null, "rename�𒆎~���܂���", "", JOptionPane.INFORMATION_MESSAGE);
									}
									else 
									{
										bufolder.mkdirs();
									...
									{
										confirmFrame.dispose();
										JOptionPane.showMessageDialog(null, "backup folder�̐����Ɏ��s���܂���", "", JOptionPane.ERROR_MESSAGE);
									}
									else
									{
										...
										confirmFrame.dispose();
										renamed = true;
										JOptionPane.showMessageDialog(null, "�t�@�C�����̕t���ւ����������܂���", "", JOptionPane.INFORMATION_MESSAGE);
		...
		else if (command.equals(SUBMIT))
		{
			...
			if (getORF2(orfField.getText()).status.equals(GeneName.ST_NONE)){
					int ans = JOptionPane.showConfirmDialog(null, "orf_descriptions.tab��ɓ������O��orf�����݂��Ȃ��t�H���_�𑗐M���悤�Ƃ��Ă��܂����A��낵���ł����H", "", JOptionPane.YES_NO_OPTION);
			...
			try
			{
				...
				if(!wr.exists())
				{
					...
					JOptionPane.showMessageDialog(null, "yeast�T�[�o�[�ւ̃t�@�C���̃A�b�v���[�h���������܂���", "", JOptionPane.INFORMATION_MESSAGE);
				}
				else
				{
					int ans = JOptionPane.showConfirmDialog(null, "���łɃT�[�o�[��ɓ���ORF���̂����t�H���_�����݂��܂����A���̃t�H���_��ɏ������݂܂����H", "��ORF���̃t�H���_�����݂��܂�", JOptionPane.YES_NO_OPTION);
					...
					{
						JOptionPane.showMessageDialog(null, "�A�b�v���[�h�𒆎~���܂���", "", JOptionPane.INFORMATION_MESSAGE);
					}
				}
			...
			catch (IOException e2)
			{
				...
				JOptionPane.showMessageDialog(null, "�T�[�o�[�ւ̃t�@�C���̏������݂Ɏ��s���܂���", "�G���[�F�T�[�o�[�ւ̏������݂Ɏ��s���܂���", JOptionPane.ERROR_MESSAGE);
			} 
			catch (HttpException e2)
			{
				//yeast�T�[�o�[�ւ̃A�N�Z�X�G���[
				System.out.println(e2.getMessage());
				JOptionPane.showMessageDialog(null, "�T�[�o�[�ւ̃t�@�C���̏������݂Ɏ��s���܂���", "�G���[�F�T�[�o�[�ւ̏������݂Ɏ��s���܂���", JOptionPane.ERROR_MESSAGE);
			}
			}
	...
	class PhotoGroup
	{
		...
		// original�̎ʐ^���������� type�́A{FITC, Rh, DAPI}��pattern match��������
	...
	// 2��PhotoNum�N���X�̑召���r����comparator
	// headerNum, sNum�̏��Ŕ�r����
		...
		passwordField.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				wr.close();
					...
					JOptionPane.showMessageDialog(null, "�p�X���[�h���Ⴄ���C���^�[�l�b�g�ڑ�������ł���܂���", "", JOptionPane.ERROR_MESSAGE);
					check = false;
				}
				catch(HttpException e2){
					JOptionPane.showMessageDialog(null, "�p�X���[�h���Ⴄ���C���^�[�l�b�g�ڑ�������ł���܂���", "", JOptionPane.ERROR_MESSAGE);
	...
	// ORF��SCMD(http://yeast.gi.k.u-tokyo.ac.jp/tools/get_orf.cgi" ����擾
	...
	//	ORF��local file(orf_descriptions.tab)����擾
		...
		try
		{
			...
			for(int i=0;i<65;i++)
			{
				...
				if(platename.equalsIgnoreCase("plate" + plateposition[0]))
				{
					...
					{
						JOptionPane.showMessageDialog(null, "���̈ʒu�̃A���t�@�x�b�g���Ԉ���Ă��܂��iA����H�܂Łj"," ", JOptionPane.ERROR_MESSAGE);
						break;
					}
					int num;
					try{
					...
					{
						JOptionPane.showMessageDialog(null, "���̈ʒu�̔ԍ����Ԉ���Ă��܂��i1����12�܂Łj", "", JOptionPane.ERROR_MESSAGE);
						break;						
					}
					if(num>0 && num<13)
					{
						...
						if((char)ch == '\n' && num != 1)
						{
							JOptionPane.showMessageDialog(null, "���̈ʒu�ɂ͊������݂��܂���", "", JOptionPane.ERROR_MESSAGE);
							break;	
						}
					}
					else
					...
					else JOptionPane.showMessageDialog(null, "���̈ʒu�ɂ͊������݂��܂���", "", JOptionPane.ERROR_MESSAGE);
					break;
				}
				if(i == 64) 
				{
					JOptionPane.showMessageDialog(null, "�v���[�g�����Ԉ���Ă��܂�", "", JOptionPane.ERROR_MESSAGE);
					break;
				}
				for(int j=0;j<10;j++)
				{
