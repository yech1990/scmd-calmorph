...
public class ImageConverter
{
    ...
    public void scaleImage(OutputStream out, URL imageURL, int scalingPercentage) throws FileNotFoundException,
    ...
    public void clipAndCombineImages(PrintStream out, File[] imageFile, BoundingRectangle clipRegion,
        ...
        String fileArgument = "";
        // TODO 画像ファイルが一部欠けていても、きちんと表示できるように対応させるべき
