...
public class GUIFrame extends JFrame {
    ...
    private void initialize() {
        ...
        this.setTitle("CalMorph Helab 2048x2048");
...
//////////////////////////////////////////////
        ...
        // test change color(by yechang)
        hor_jp.setBackground(Color.red);
        ver_jp.add(hor_jp);
        ...
        for(int i=0;i<7;i++) {
            s[i] = new String(""+((i+1)*100));
        }
        maximage_cob = new JComboBox(s);
        maximage_cob.setSelectedIndex(0);
